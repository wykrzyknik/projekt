...
{block name=title}Lista Uczestników{/block}
...
<td>{$row['id']}</td>
  ...
  <td><span class="btn-group pull-right">
		<a href="{$protocol}{$smarty.server.HTTP_HOST}{$subdir}uczestnik/{$row['id']}" type="button" class="btn btn-primary btn-sm"
		...
		<button type="button" class="btn btn-primary btn-sm edit-button"
          data-url="uczestnik/formularz-edycja/{$row['id']}/"
          data-toggle="tooltip" data-placement="top" title="Edytuj uczestnik">
          <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
    </button>
		<a href="{$protocol}{$smarty.server.HTTP_HOST}{$subdir}uczestnik/usun/{$row['id']}/" type="button" class="btn btn-danger btn-sm delete-button"

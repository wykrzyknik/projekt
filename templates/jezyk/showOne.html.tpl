...
{block name=title}Szczegółowe informacje o jezyk{/block}
...
<div class="row">
  <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
    <div class="thumbnail">
      <div class="caption">
        <h4><span style="color:red">Id</span> {$data['id']} </br> <span style="color:red">NazwaJezyka</span> {$data['NazwaJezyka']} </br> </h3>
        <p class="text-right">
          <a href="{$protocol}{$smarty.server.HTTP_HOST}{$subdir}jezyk/usun/{$data['id']}" type="button" class="btn btn-danger btn-sm delete-button"
